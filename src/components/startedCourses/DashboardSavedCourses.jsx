...
export default function DashboardSavedCourses({user}) {
  ...
  return (
    <div className="overflow-hidden min-h-screen top-auto flex-auto xl:max-w-full  px-5 lg:max-w-7xl md:max-w-5xl">
      ...
      {/* <div className="CONTENT DIV flex flex-col mx-auto max-w-7xl"> */}
        {/* {session && (
          <Link
            href="/sign-out"
        ...
        {/* <div className="HEADING DIV md:mt-12 mt-6 overflow-hidden relative flex w-full lg:ml-80 md:ml-60 font-popins">
          <Title text="MORE COURSES FOR YOU" className="font-popins"/>
        </div> */}
        <div>
