...
const DomainCard = ({ title, img }) => {
  return (
    <div className="border-[1.5px] border-purple-500 rounded-xl h-[70px] sm:h-[100px] md:h-[100px] lg:h-[125px] max-w-[350px] min-w-[200px] sm:min-w-[150px] relative flex justify-between group object-cover overflow-hidden mx-3 my-3">
