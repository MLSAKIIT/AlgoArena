  ...
  return (
    <>
      <div className="flex flex-col items-center justify-center w-5/6">
        ...
        ></textarea>
        <br />
        <button className=" box-border mt-3 py-1 px-1 bg-[#9d5ae3] text-white w-40 h-14 rounded-full shadow-[0_0_1rem_0px_#9d5ae3] text-xl  outline-none border-none [text-shadow:_0px_0px_5px_rgb(0_0_0)] cursor-pointer hover:bg-[#7f3dbf] active:scale-95 transition duration-200 z-1">
          Send
        </button>
      </div>
    </>
