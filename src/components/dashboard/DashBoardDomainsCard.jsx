...
const DomainCard = ({title, content, progress, redirectURL}) => {
    return (
        <div className="z-2 hover:shadow-[0_0_16px_3px_#4a0f87] hover:scale-105 hover:backdrop-blur-sm transition-all backdrop-blur-sm border-[1.5px] border-purple-500 rounded-xl cursor-pointer h-[100px] sm:h-[150px] md:h-[150px] lg:h-[175px] max-w-[350px] md:w-[250px] relative flex flex-col justify-around overflow-hidden mx-3">
            <div className="flex justify-center items-center">
                ...
                <a href={redirectURL} className="cursor-pointer w-2/12">
                    <Image src="dashboard_btn_icon.svg" alt="progress" width={22} height={22} />
                </a>
            </div>

            {/* progressbar div*/}
            <div className="bg-white h-1 mx-4 rounded-lg">
