...
export default function CompletedCourses({user}) {
    ...
    return (
        <div className="overflow-hidden min-h-screen top-auto flex-auto xl:max-w-full  px-5 lg:max-w-7xl md:max-w-5xl">
            ...
            <div className="flex flex-col mx-auto justify-between  xl:max-w-7xl md:max-w-5xl sm:max-w-4xl max-w-screen items-center">
                {/* {session && (
          <Link
            href="/sign-out"
          ...
          >
            Sign out
                ...
                <div className="flex w-full xl:ml-60 lg:ml-0 sm:ml-60 md:ml-28 md:mt-12 mt-12 overflow-hidden relative ">
                    <h1 className="text-4xl font-bold font-sans bg-gradient-to-r from-white to-[#9d5ae3] inline-block text-transparent bg-clip-text mt-8">COMPLETED COURSES</h1>
                </div>

                <div className="flex sm:pl-7 flex-col mt-5">
                    <CompletedCoursesList />
                </div>

                <div className="HEADING DIV md:mt-12 mt-6 overflow-hidden relative flex w-full lg:ml-80 md:ml-60">
                    <h1 className="text-4xl font-bold font-sans bg-gradient-to-r from-white to-[#9d5ae3] inline-block text-transparent bg-clip-text mt-8">MORE COURSES FOR YOU </h1>
                </div>
