      ...
      <div className="relative h-full min-w-screen max-w-[180rem] ">
        ...
        <div className="mx-10 text-xs mix-blend-exclusion">
          ...
          <div className="mt-5  md:flex md:justify-between">
            <div className="w-3/2 xs:w-1/2 text-xss xs:text-xs md:w-3/12 lg:w-3/12  font-[500] max-w-md sm:w-50 text-white">
              {header.description}
            </div>
          ...
          <div className="flex  gap-6 sm:mt-3 md:mt-2 font-[500] lg:mt-1">
            <div className="flex gap-2">
              <Image
                ...
                alt="play-bttn"
              />
              <p className="text-xss xs:text-xs ">{videos} Videos</p>
            </div>
            <div className="flex gap-2">
              <Image
                ...
                alt="time-img"
              />
              <p className="text-xss xs:text-xs text-white ">
                {header.time} hours
              </p>
            </div>
          </div>
          <div className="flex my-3 gap-2">
            ...
            <div>
              <p className="text-xss font-semibold xs:text-xs">
