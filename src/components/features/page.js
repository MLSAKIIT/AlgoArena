...
      </div>
      ...
      <div className='pt-20 ml-50 mr-40'>
        <div className='flex justify-evenly'>
        <div>
          <Image src={learning} height={500} width={500}/>
        </div>
        <div className='ml-40 w-748 h-135'>
        ...
        <div className='flex justify-evenly'>
        <div>
          <Image src="/public/images/learning.png" width={500} height={500} alt="Picture"/>
        </div>
        <div className='ml-40 w-748 h-135'>
          <p className='text-3xl font-poppins leading-7 tracking-tighter font-bold uppercase bg-gradient-to-r from-white to-purple-500 bg-clip-text text-transparent inline-block'>
